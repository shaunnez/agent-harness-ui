...
export function App() {
  ...
  const saveRuntimeSettings = async (
    ...
    > &
      Partial<Pick<RuntimeSettings, "grillPolicy" | "gatePolicies" | "designPolicies">>,
  ) => {
              ...
              try {
                ...
                showToast(
                  ...
                  action === "grant-retry"
                    ...
                    : action === "reconcile-authority"
                      ? "Candidate authority reconciled against the verified target."
