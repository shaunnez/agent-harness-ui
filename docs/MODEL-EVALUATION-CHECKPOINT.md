...
Updated: 22 September 2026. **Rebased onto merged main `3878a24`. The planning treatment assembled the first qualified candidate, then exposed a frozen-target runtime defect before Dev Review. Its original trial is invalid; a diagnostic continuation under the corrected harness is being prepared. No model policy promoted. Batch B was not launched.** Inspect the private live brief before dispatch.
