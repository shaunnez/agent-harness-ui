...
export function createTaskLifecycleRoutes({ store, orchestrator, worktrees, continuationLocks, send, readJson, validateRepository, worktreeEntriesForTask, withActionEligibility }) {
