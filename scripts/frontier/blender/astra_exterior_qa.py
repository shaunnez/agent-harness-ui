...
import json,hashlib
ROOT=Path(__file__).resolve().parents[3];R=ROOT/'design/mission-frontier/assets/staging/cinematic-v1/astra/exterior-calibration';Q=R/'qa';Q.mkdir(exist_ok=True)
